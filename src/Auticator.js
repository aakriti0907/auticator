...
function Auticator() {
  return (
    ...
    <button className="buttons" variant="outline-primary">Primary</button>{' '}
  	<button className="buttons" variant="outline-primary">
  	Watch Cartoons
  	</button>{' '}
  	<button className="buttons" variant="outline-primary">
    ...
    <p>
  	<h2a>WHY US?</h2a>  
       <img  src="Brain.png" alt="Brain" align="right" style={{height: "300px", width: "300px", align: "right" }} /><br/>
   ...
   <div className="connect">
     ...
     <img  align="right" src="connect.jpeg" alt="Brain" style={{height: "300px", width: "300px", align: "right" }} />
 	<ul>
     	<li>Instagram{" "}
